...
> 📸 *[Скриншот 3 — Страница мастера установки WordPress (форма с данными БД)]*

> 📸 *[Скриншот 4 — Успешное завершение установки WordPress]*

> 📸 *[Скриншот 5 — Главная страница админ-панели (Консоль)]*
...
> 📸 *[Скриншот 6 — Раздел «Общие настройки» с изменённым названием и часовым поясом]*
...
> 📸 *[Скриншот 7 — Настройки постоянных ссылок с выбранным вариантом «Название записи»]*
...
> 📸 *[Скриншот 8 — Раздел «Темы» с активированной темой Astra]*

> 📸 *[Скриншот 9 — Вид сайта до установки темы Astra (стандартная тема)]*

> 📸 *[Скриншот 10 — Вид сайта после установки темы Astra]*
...
> 📸 *[Скриншот 11 — Настройщик темы с логотипом, названием и описанием сайта]*

> 📸 *[Скриншот 12 — Настройка цветовой схемы]*
...
> 📸 *[Скриншот 13 — Список установленных плагинов (Classic Editor и Contact Form 7 активированы)]*

> 📸 *[Скриншот 14 — Классический редактор записей (Classic Editor активен)]*

> 📸 *[Скриншот 15 — Раздел Contact Form 7 с готовой формой]*
...
> 📸 *[Скриншот 16 — Classic Editor деактивирован в списке плагинов]*

> 📸 *[Скриншот 17 — Блочный редактор Gutenberg после деактивации Classic Editor]*
...
> 📸 *[Скриншот 18 — Редактор страницы «Контакты» с вставленным шорткодом]*

> 📸 *[Скриншот 19 — Страница «Контакты» на сайте с отображённой формой обратной связи]*
...
> 📸 *[Скриншот 20 — Запись 1 в редакторе]*

> 📸 *[Скриншот 21 — Запись 2 в редакторе]*
...
> 📸 *[Скриншот 22 — Главная страница сайта с записями блога]*

> 📸 *[Скриншот 23 — Страница «Контакты» с формой на живом сайте]*
